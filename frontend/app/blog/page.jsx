        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="mt-6 max-w-2xl">
            <input
              ...
              placeholder="Search posts by topic, act, or keyword…"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((post, i) => (
            ...
            >
              ...
              >
                <div className="h-full bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-white/20 hover:-translate-y-1 transition-all duration-300">
                  {/* Color strip */}
                  ...
                  <div className="p-6">
                    ...
                    <span className="inline-flex items-center gap-1.5 text-sm font-medium text-indigo-300 group-hover:gap-2.5 transition-all group-hover:text-indigo-200">
